...
import Link from 'next/link'; // <-- CORRECTED: Importing Link from 'next/link'
    ...
    <div className="flex min-h-screen w-full flex-col">
      <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-background px-4 md:px-6">
        <nav className="hidden flex-col gap-6 text-lg font-medium md:flex md:flex-row md:items-center md:gap-5 md:text-sm lg:gap-6">
          {/* Using Next.js Link. href is used instead of to */}
          <Link href="#" className="flex items-center gap-2 text-lg font-semibold md:text-base">
            <span className="sr-only">OmniTrack</span>
          </Link>
        ...
        <div className="flex w-full items-center gap-4 md:ml-auto md:gap-2 lg:gap-4">
          <button
            ...
            style={{
              ...
              marginLeft: 'auto', // Push it to the right if needed, adjust as per your layout
            }}
          >
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-10">
        <h1 className="text-3xl font-bold">Welcome back, DeruzDev!</h1>
      ...
      {/* The CommandBar component remains here */}
